...
Möchtest du einen Kassenzettel von deinem Einkauf einscannen, hast du zwei Optionen.
Die erste Option ist, den Kassenzettel per Kamera Einzuscannen:

1. Tippe auf den mittleren Scan-Button in der unteren Leiste
2. Ist dein Kassenzettel gut zu sehen, tippe den weißen Auslösebutton um ein Foto zu machen
3. Nachdem dein Foto eingescannt wurde, sehen Sie das der Preis, dass aktuelle Datum und die Transaktionen automatisch eingetragen wurden
4. Nun kannst du den Namen, das Konto, ggf. eine Notiz eintragen
5. Es können jedoch alle Eingaben manuell geändert werden
6. Möchtest du eine Transkation hinzufügen, klicke auf den "Hinzufügen" Button
Wenn du "Hinzufügen" klickst, kannst du den Namen der Transaktion eintragen, auswählen zwischen Einkommen und Ausgabe wählen und den Betrag angeben. Außerdem kannst du eine Kategorie auswählen
7. Möchtest du keine Transaktion hinzufügen, tippe auf "Abbrechen", um zur vorherigen Ansicht zurückzukehren
8. Tippe auf "Hinzufügen", um ein Transaktion zu speichern
9. Möchtest du eine Transkation bearbeiten, kannst du sie über den roten Button mit dem Mülleimer Icon die Transaktion löschen oder über den gelben Button die Transaktion bearbeiten und dort die Eigenschaften anpassen, gleich zu der Erstellung einer Transaktion
...
1. Klicke dafür auf den mittleren Scan-Button in der unteren Leiste
2. Tippe dann auf den "Galerie" Button unten rechts 
3. Die Galerie App wird sich öffnen und du musst dein gewolltes Bild auswählen
...
3. Gib den Namen, das Datum (standardmäßig das aktuelle Datum, aber manuell änderbar), das Konto, ggf. eine Notiz ein.
...
8. Tippe anschließend auf den "Speichern" Button, um den Eintrag zu sichern
...
3. Füge Namen, den Betrag, den du für das Budget ausgeben möchtest sowie ein Startdatum und zugehörige Kategorien hinzu. Vergebe optional eine Farbe und ein Emoji nach deiner Wahl
