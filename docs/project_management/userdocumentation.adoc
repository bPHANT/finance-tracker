...
3. Gib den Namen, das Datum (standard,äßig das aktuelle Datum, aber manuell änderbar), das Konto, ggf. eine Notiz und die Summe ein.
4. Optional kannst du über den Button "Add" unter dem "Speichern" Button eine Transaktion hinzufügen
5. Wenn Sie "Add" klicken, können Sie den namen der Transaktion eintragen, auswählen zwischen Einkommen und Ausgabe wählen und den Betrag angeben. Außerdem können Sie eine Kategorie auswählen
6. Möchten Sie keine Transaktion hinzufügen, tippen Sie auf "Abbrechen", um zur vorherigen Ansicht zurückzukehren
7. Tippe auf "Add", um ein Transaktion zu speichern
...
Um eine neue Kategorie zu bearbeiten, gehst du zuerst auf den Einstellungstab (Zahnrad Symbol). Dort klickst du auf den Button „Kategorien verwalten“. Dann wählst du eine Kategorie aus, welche du bearbeiten möchtest. Möchtest du eine neue erstellen klickst du oben rechts das Plus (+) an. Dort wählst du einen Namen aus, die Farbe und den Emoji. Außerdem kannst du der Kategorie auch eine Oberkategorie zuweisen. Hast du dies alles ausgefüllt, kannst du einfach „speichern“ drücken. 
Wenn du eine Kategorie bearbeiten möchtest, wählst du nicht das Plus (+), sondern eine vorhandene Kategorie. Dort kannst du den Namen, die Farbe, den Emoji oder die Oberkategorie ändern und mit dem Button „speichern“ einfach bestätigen. 
