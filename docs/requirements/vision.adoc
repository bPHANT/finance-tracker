...
| die | schnell, unkompliziert und individuell zugeschnitten Einnahmen erfasst und durch KI intelligent mitdenkt,
...
| sehr hoch
a|
* Möglichkeit, Kategorien zu erstellen, zu bearbeiten und zu löschen
...
| Nutzer wollen ihre Einnahmen und Ausgaben nach Konten/Geldquellen trennen können, damit sie einen besseren Überblick über diese Konten/Geldquellen behalten können.
| hoch
a|
...
| Nutzer wollen Sparziele festlegen können, damit sie motiviert und gezielt Geld für Anschaffungen/Ziele zurücklegen können.
| mittel
a|
...
| Nutzer wollen ein übersichtliches Dashboard, das alle wichtigen Informationen auf einen Blick darstellt.
| mittel
a|
...
| Gute Leistung (Die App soll auf allen gängigen Mittelklassegeräten bis 2020 gut laufen, also keine spürbaren Verzögerungen bei der Bedienung; >3 Sekunden)
| sehr hoch
| MVP

| Benutzerfreundlichkeit - (Dashboard mit Saldo, Budgets und Sparzielen auf einen Blick. Anlegen einer Einnahme oder Ausgabe in max. 3 Schritten und klare Fehlermeldungen.)
| sehr hoch
| MVP
